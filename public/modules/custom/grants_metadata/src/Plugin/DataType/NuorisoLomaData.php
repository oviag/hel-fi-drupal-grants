 ...
 *
 * @DataType(
 * id = "grants_metadata_nuorisoloma",
 * label = @Translation("Nuoriso loma"),
 * definition_class =
 *   "\Drupal\grants_metadata\TypedData\Definition\NuorisoLomaDefinition"
 * )
 */
class NuorisoLomaData extends Map {
