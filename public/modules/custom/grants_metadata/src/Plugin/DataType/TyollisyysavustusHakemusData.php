 ...
 *
 * @DataType(
 * id = "grants_metadata_tyollisyysavustushakemus",
 * label = @Translation("Tyollisyysavustushakemus"),
 * definition_class =
 *   "\Drupal\grants_metadata\TypedData\Definition\TyollisyysavustusHakemusDefinition"
 * )
 */
class TyollisyysavustusHakemusData extends Map {
