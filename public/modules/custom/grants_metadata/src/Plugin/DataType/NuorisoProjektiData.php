 ...
 *
 * @DataType(
 * id = "grants_metadata_nuorisoprojekti",
 * label = @Translation("Nuorisopalvelu: projektiavustushakemus"),
 * definition_class =
 *   "\Drupal\grants_metadata\TypedData\Definition\NuorisoProjektiDefinition"
 * )
 */
class NuorisoProjektiData extends Map {
