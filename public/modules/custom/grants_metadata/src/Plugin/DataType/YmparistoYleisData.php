...
/**
 * Ympäristöpalvelut: Yleisavustushakemus DataType.
 *
 * @DataType(
 * id = "grants_metadata_ymparisto_yleis",
 * label = @Translation("Ympäristöpalvelut: Yleisavustushakemus"),
 * definition_class =
 *   "\Drupal\grants_metadata\TypedData\Definition\YmparistoYleisDefinition"
 * )
 */
class YmparistoYleisData extends Map {
