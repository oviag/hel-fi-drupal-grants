 ...
 *
 * @DataType(
 * id = "grants_metadata_liikuntalaitos",
 * label = @Translation("Liikunta laitosavustus"),
 * definition_class =
 *   "\Drupal\grants_metadata\TypedData\Definition\LiikuntaLaitosDefinition"
 * )
 */
class LiikuntaLaitosData extends Map {
