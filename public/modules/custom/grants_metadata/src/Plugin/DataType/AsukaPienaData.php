 ...
 *
 * @DataType(
 * id = "grants_metadata_asukaspien",
 * label = @Translation("Asukasosallisuus, pienavustushakemus"),
 * definition_class =
 *   "\Drupal\grants_metadata\TypedData\Definition\AsukaPienaDefinition"
 * )
 */
class AsukaPienaData extends Map {
