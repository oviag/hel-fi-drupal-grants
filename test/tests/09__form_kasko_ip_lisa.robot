...
Start New Application
    Click      .view-application-search \#iltapaivatoiminnan-harkinnanvarainen-lisaavustushakemus
    Click      \#block-servicepageauthblock .hds-button
    Get Title           ==    Kasvatus ja koulutus: Iltapäivätoiminnan harkinnanvarainen lisäavustushakemus | ${SITE_NAME}
